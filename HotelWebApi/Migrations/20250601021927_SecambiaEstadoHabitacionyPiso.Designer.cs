...
namespace HotelWebApi.Migrations
{
    ...
    [Migration("20250601021927_SecambiaEstadoHabitacionyPiso")]
    partial class SecambiaEstadoHabitacionyPiso
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HotelWebApi.Models.Sucursales", b =>
                {
                    ...
                    b.Property<string>("Direccion_Sucursal")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HotelWebApi.Models.TipoHabitacion", b =>
                {
                    ...
                    b.Property<double>("Precio_EstadoHabitacion")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("HotelWebApi.Models.Sucursales", b =>
                {
                    ...
                    b.Navigation("Sucursales_Usuarios");
                });
